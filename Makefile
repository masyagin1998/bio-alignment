...
$(MAIN_OBJS_PREFIX)%.o: $(MAIN_SRC_PREFIX)%.c
	...
	$(CC) $(CFLAGS) -I$(FASTA_SRC_PREFIX) -I$(NW_SRC_PREFIX) -I$(SW_SRC_PREFIX) -I$(HB_SRC_PREFIX) -I$(SCORING_FUNCTIONS_SRC_PREFIX) -I$(UTILS_SRC_PREFIX) -c $< -o $@

$(BIN_PREFIX)bio-alignment: $(FASTA_OBJS) $(NW_OBJS) $(SW_OBJS) $(HB_OBJS) $(MAIN_OBJS) $(SCORING_FUNCTIONS_OBJS)
	mkdir -p $(BIN_PREFIX)
